...
export default function StoryPage() {
  return (
    <div className="py-12 md:py-16">
      ...
      {/* 스토리 1 */}
      <section className="border-t border-[#E0E0E0] py-16">
        <div className="container-custom max-w-2xl">
          <h2 className="text-2xl font-bold mb-6">왜 양말인가?</h2>
      ...
      <section className="bg-[#F5F5F5] py-16">
        <div className="container-custom max-w-2xl">
          <h2 className="text-2xl font-bold mb-6">양마르의 시작</h2>
          <div className="space-y-4 text-[#666] leading-relaxed">
            <p>
              2024년 겨울, 우리는 물었습니다.
      ...
      <section className="py-16">
        <div className="container-custom max-w-2xl">
          <h2 className="text-2xl font-bold mb-8">우리의 약속</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              <div key={item.title} className="border border-[#E0E0E0] rounded-xl p-6">
